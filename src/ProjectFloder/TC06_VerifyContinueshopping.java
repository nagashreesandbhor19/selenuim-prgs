...
public class TC06_VerifyContinueshopping {
	...
	//home page
		 ...
		 bp.clickcontinueshoppingbtn();
		 System.out.println("clicked on continueshopping button");
		 ...
		 System.out.println("Apply verfication");
			...
			{
				System.out.println("continueshopping test case is pass");
			}
			else
			{
				System.out.println("continueshopping test case is fail");
